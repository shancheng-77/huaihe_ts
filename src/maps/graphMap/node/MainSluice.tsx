...
export function MainSluice({x, y, width = 25, height = 60, nodeName}: Props) {
	...
	return (
		<>
			<rect x={x} y={y} width={width} height={height}
				...
				onClick={handleClick}
			/>
			<text x={x+13} y={y+10} style={{writingMode:'vertical-rl',fontSize:15,cursor:'pointer',userSelect:'none',fill:Color.fontColor}}
				onClick={handleClick}
			>{nodeName}</text>
